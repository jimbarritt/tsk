...
Still remaining for this task: the M-ADMIN-03 consumer side (reading the queue, the watermark cursor, the per-event processing loop) — not built yet. The producer side (this Action) is proven end to end with real data. | none | none | TODO |
